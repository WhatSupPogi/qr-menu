        ...
        <div className="section-head compact-head">
          <div>
            ...
            <p className="muted section-text">
              Keep names short and clear so customers can scan them quickly.
            </p>
          </div>
        </div>
        ...
        <form id="product-form" className="grid grid-2" onSubmit={submitProduct}>
          ...
          {imageBlocked ? (
            <div className="notice" style={{ gridColumn: '1 / -1' }}>
              Your image limit has been reached. You can still edit text, price, or stock.
            </div>
          ) : null}
      ...
      <section className="card">
        <div className="section-head">
          <div>
            ...
            <p className="muted section-text">Use search to find an item quickly.</p>
          </div>
