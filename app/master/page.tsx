            ...
            <tbody>
              {filteredStores.map((store: any) => (
                <tr key={store.id}>
                  ...
                  <td>
                    <span className={`badge ${store.status}`}>
                      {store.status}
                    </span>
                  </td>
                  ...
                  <td>
                    <div className="inline-actions wrap-actions">
                      ...
                      <a
                        ...
                        href={`/api/master/store?slug=${encodeURIComponent(store.slug)}`}
                      >
                        Download QR
                      </a>
                      ...
                      <form action="/api/master/store" method="post" className="stack gap-8 full-width-card">
                        <input type="hidden" name="mode" value="admin" />
                        <input type="hidden" name="store_id" value={store.id} />
                        <input type="email" name="admin_email" placeholder="New admin email" />
                        <input type="text" name="admin_password" placeholder="New admin password" />
            ...
            <table>
              ...
              <tbody>
                ...
                {attempts.length === 0 && (
                  <tr>
                    <td colSpan={4}>
                      <small>No login attempts yet.</small>
                    </td>
                  </tr>
                )}
              </tbody>
